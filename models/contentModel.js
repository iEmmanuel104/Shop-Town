module.exports = (sequelize, DataTypes) => {
    const Ksocial = sequelize.define(
        'Ksocial',
        {
            id: {
                type: DataTypes.UUID,
            ...
            likesCount: {
                ...
                get() {
                    ...
                    return this.postActivities.filter((activity) => activity.like === true).length;
                },
            },
            commentsCount: {
                type: DataTypes.VIRTUAL,
                get() {
                    ...
                    return this.postActivities.filter(
                        (activity) => activity.comment !== null && activity.comment !== '',
                    ).length;
                },
            },
        },
    ...
    Ksocial.associate = (models) => {
        ...
        Ksocial.belongsTo(models.Store, {
            foreignKey: 'storeId',
            onDelete: 'CASCADE',
        });
    };
